...
4. 在搜索框中输入 `buddha` 搜索即可看到 DPD 信息栏

## 第四步：验证

在 <a href="https://next.wikipali.cc" target="_blank" rel="noopener">Wikipali 页面</a>点击工具栏 Violentmonkey 图标，可以看到 DPD 脚本的菜单项：

![Violentmonkey 菜单](../img/screenshots/violentmonkey扩展dpd脚本的菜单项.webp)

搜索 `buddha` 后结果上方会显示 DPD 信息栏：
