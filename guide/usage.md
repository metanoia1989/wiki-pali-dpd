...
所有 AI 问答记录自动缓存到本地。通过 Violentmonkey 菜单中的 **「LLM 问答记录」** 可以浏览和回顾。

## Violentmonkey 菜单功能

安装脚本后，点击浏览器工具栏中的 Violentmonkey 图标，可以看到以下菜单项：

![Violentmonkey 菜单](../img/dpd-menu.svg)
