...
安装并下载数据后，打开 <a href="https://next.wikipali.cc" target="_blank" rel="noopener">Wikipali 词典页面</a>（以新标签页打开）：
...
安装脚本后，在 <a href="https://next.wikipali.cc" target="_blank" rel="noopener">Wikipali 页面</a>点击浏览器工具栏中的扩展图标，可以看到以下菜单项：
